...
def get_document_analysis_prompt(job_title: str, doc_type: str, document_content: Dict[str, Any]) -> str:
    ...
    if doc_type == "resume":
        ...
        qa_list = document_content.get('qa', [])
        feedback_sections = []
